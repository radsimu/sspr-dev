...
public class MaltParserService {
	...
	public void runExperiment(String commandLine) throws MaltChainedException {
		...
		om.parseCommandLine(commandLine, optionContainer);
		if (om.getOptionValue(optionContainer,"system", "option_file") != null && om.getOptionValue(optionContainer, "system", "option_file").toString().length() > 0) {
			om.parseOptionInstanceXMLfile((String)om.getOptionValue(optionContainer,"system", "option_file"));
		}
