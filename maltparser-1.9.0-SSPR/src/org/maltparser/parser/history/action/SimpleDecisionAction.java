...
public class SimpleDecisionAction implements  SingleDecision {
	...
	private final ScoredKBestList kBestList;
	...
	public SimpleDecisionAction(int kBestSize, TableContainer _tableContainer) throws MaltChainedException {
		...
		this.kBestList = new ScoredKBestList(kBestSize, this);
		clear();
	}
	...
	public ScoredKBestList getKBestList() throws MaltChainedException {
		return kBestList;
	}
